...
// Sun Feb  7 09:36:07 2021 by ROOT version 6.22/06
...
Int_t TReadTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TReadTree::LoadTree(Long64_t entry)
{
...
void TReadTree::Init(TTree *tree)
{
...
void TReadTree::Show(Long64_t entry)
{
...
Int_t TReadTree::Cut(Long64_t entry)
{
