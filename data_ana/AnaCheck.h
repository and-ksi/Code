...
#ifdef AnaCheck_cxx
AnaCheck::AnaCheck(TTree *tree) : fChain(0)
{
...
Long64_t AnaCheck::LoadTree(Long64_t entry)
{
...
void AnaCheck::Show(Long64_t entry)
{
...
Int_t AnaCheck::Cut(Long64_t entry)
{
